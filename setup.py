...
if platform.system() == 'Windows':
    ...
    extra_compile_args = ['/DCL_TARGET_OPENCL_VERSION=300', '/DCL_HPP_ENABLE_EXCEPTIONS']
...
ext_modules = [
    Pybind11Extension(
        'MyTorchCPP',
        sources=['csrc/MyTensor.cpp', 'csrc/MyTorch.cpp', 'csrc/utils.cpp', 'csrc/Proxy.cpp', 'csrc/helpers.cpp', 'csrc/OpenCLManager.cpp'],
